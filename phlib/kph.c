    ...
    )
{
    ...
    *RtlSubAuthoritySid(administratorsSid, 1) = DOMAIN_ALIAS_RID_ADMINS;
    ...
    RtlAddAccessAllowedAce(dacl, ACL_REVISION, STANDARD_RIGHTS_REQUIRED | SERVICE_QUERY_CONFIG | 
        SERVICE_QUERY_STATUS | SERVICE_START | SERVICE_STOP | DELETE, &PhSeInteractiveSid);
